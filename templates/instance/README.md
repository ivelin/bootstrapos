...
Self-host disk kit: same `company-state.json` + `where-are-we.py`; call `bootstrap_use_company` then `bootstrap_where_are_we` for **this** company only. Not the Pirin hosted write plane.
