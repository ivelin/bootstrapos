...
**v2.8.18 — idea-board admission (bet class)**  
House rule. Full text: [operating-system.md](company-os/operating-system.md#house-rule-an-idea-board-is-a-customer-thesis). Same family as legal paper and advisor ride-along; do not merge. An idea board is a customer thesis — named-group kill line (pay or use). A person, hire, or instrument is not an idea board. Hold it in the instrument tracker. No third clock. No schema bump. Implicit loop from 2.8.17 stays.
