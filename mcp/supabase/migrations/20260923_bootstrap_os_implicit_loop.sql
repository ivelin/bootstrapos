-- OS 2.8.17 implicit loop: reject loop_stage mutations and spoken-label writes.
-- Ask / Do / Write back is a quality bar, not a stored week verb and not a card.
-- Omit or identical no-op only. No schema bump of stored 1–7.
